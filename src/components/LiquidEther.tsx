...
void main(){
  ...
  gl_FragColor = vec4(newv, 0.0, 0.0);
    ...
    const Mouse: any = {
      ...
      docTarget: null as Document | null,
      listenerTarget: null as Window | null,
      isHoverInside: false,
      ...
      updateHoverState(cx: number, cy: number) {
    ...
    // ── AutoDriver ───────────────────────────────────────────────────────────────
    class AutoDriver {
      mouse: any; manager: any; enabled: boolean; speed: number;
      resumeDelay: number; rampDurationMs: number; active: boolean;
      current: THREE.Vector2; target: THREE.Vector2;
      lastTime: number; activationTime: number; margin: number;
    ...
    // ── Simulation ───────────────────────────────────────────────────────────────
    class Simulation {
      options: any; fbos: any; fboSize: THREE.Vector2;
    ...
    // ── WebGLManager ─────────────────────────────────────────────────────────────
    class WebGLManager {
      props: any; output: Output | null; autoDriver: AutoDriver | null;
      lastUserInteraction: number; running: boolean;
  ...
  // Sync live prop changes without remounting
  useEffect(() => {
